...
`,ve=t=>t<10?`0${t}`:t;function ye(t,e){const[r,i,n]=function(t,e){switch("automatic"===e?t>=3600?"minutes":"seconds":e){case"seconds":return[Math.floor(t/3600),Math.floor(t%3600/60),Math.floor(t%3600%60)];case"minutes":return[0,Math.floor(t/3600),Math.floor(t%3600/60)]}}(t,e);return r>0?`${r}:${ve(i)}:${ve(n)}`:i>0?`${i}:${ve(n)}`:n>0?""+n:null}function _e(t){return Object.assign(Object.assign({active_state:["active","on","manual","program","once_program"],pause_state:"paused",waiting_state:"waiting",guess_mode:!1,end_time:{attribute:"end_time"},start_time:{attribute:"start_time"},duration:{attribute:"duration"},remain_time:{attribute:"remain_time"},sync_issues:"show",bar_width:"calc(70% - 7em)",bar_height:"8px",text_width:"3.5em",bar_background:"#eee",bar_foreground:"var(--mdc-theme-primary, #6200ee);",bar_radius:"0",layout:"normal",resolution:"seconds"},t),{translations:Object.assign({scheduled_for:"Scheduled for",once_program:"Once Program",program:"Program",manual:"Manual",waiting:"Waiting"},t.translations)})}class we extends Q{constructor(){super(...arguments),this._previousClockCorrection=0,this._browserClockCorrection=0}disconnectedCallback(){super.disconnectedCallback(),this._clearInterval()}connectedCallback(){var t;if(super.connectedCallback(),this.config&&this.config.entity){const e=null===(t=this.hass)||void 0===t?void 0:t.states[this.config.entity];e&&this._startInterval(e)}}_mode(){return ee(this.hass,this.config,this._browserClockCorrection)}render(){var t,e,r;const i=this.hass.states[this.config.entity];if(this._error)return T`<hui-warning>${this._error.message}</hui-warning>`;let n,s=0;i&&(s=null!==(t=Vt(this.hass,this.config,i,this._browserClockCorrection))&&void 0!==t?t:0),s>100&&(s=100);try{n=Object.assign(Object.assign({},this.modConfig),{icon:null!==(e=this.modConfig.active_icon)&&void 0!==e?e:this.modConfig.icon})}catch(t){return T`<div>${t}</div>`}const a="none"!==(null===(r=n.tap_action)||void 0===r?void 0:r.action)?"pointer":"";switch(this._mode()){case"active":return this._renderRow(n,T`
      ...
      `);default:const t=this.modConfig.text_width&&0===parseInt(this.modConfig.text_width)?"visibility: hidden":"";return this._renderRow(this.modConfig,T`
        ...
        @action=${fe(this.hass,this.config)}
       .actionHandler=${ge(this.config)}
        >${this.localize(i)}</div>
      `)}}localize(t,e=!0){return function(t,e,r,i,n=!0){if(!e)return"";if(i&&i[e])return i[e];if(r){const i=Ut(t.localize,r,t.locale,e);if(i!==e)return n?i:i.toLowerCase()}const s=function(t,e){return"idle"===e?t.localize("component.timer.state._.idle"):"paused"===e?t.localize("component.timer.state._.paused"):"active"===e?t.localize("component.timer.state._.active"):"on"===e?t.localize("component.switch.state._.on"):void 0}(t,e);return s?n?s:s.toLowerCase():n?e[0].toUpperCase()+e.substring(1):e}(this.hass,null==t?void 0:t.state,t,this.config.translations,e)}_renderRow(t,e){const r=this._warning?T`<hui-warning>${this._warning}</hui-warning>`:"";return this.modConfig.full_row||"full_row"===this.modConfig.layout?T`${r}<div class="flex" @action=${fe(this.hass,t)} .actionHandler=${ge(t)}> ${e}</div>${this._renderDebug()}`:("hide_name"===this.modConfig.layout&&(t=Object.assign(Object.assign({},t),{name:""})),T`
      ${r}
    ...
    ${pe(r.extend_paper_buttons_row,"center")}
    ${t}
    ${pe(r.extend_paper_buttons_row,"right")}
  </div>`}(e,this.hass,t)}
      ${this._renderDebug()}
    `)}_renderTime(t){return T`<div class="text-content value ${t}" style=${this._textStyle()}
      @action=${fe(this.hass,this.config)}
      .actionHandler=${ge(this.config)}>
      ${ye(this._timeRemaining||0,this.modConfig.resolution)}
