...
//  Handle Configuration Flags
    ...
    var currentText = this.config.entity_current_text ? html`<span class="currentText" @click="${() => this.openEntityPopover(this.config.entity_current_text)}">${this._hass.states[this.config.entity_current_text].state}</span>` : ``;
    var apparentTemp = this.config.entity_apparent_temp ? html`<span class="apparent" @click="${() => this.openEntityPopover(this.config.entity_apparent_temp)}">${this.localeText.feelsLike} ${this.current.apparent} ${this.getUOM("temperature")}</span>` : ``;
    var summary = this.config.entity_daily_summary ? html`<br><span class="unit" @click="${() => this.openEntityPopover(this.config.entity_daily_summary)}">${this._hass.states[this.config.entity_daily_summary].state}</span></br>` : ``;
...
// Build HTML
    return html`
      ...
      <ha-card class = "card">
        ...
        <span class="temp" @click="${() => this.openEntityPopover(this.config.entity_temperature)}">${this.current.temperature}</span><span class="tempc">${this.getUOM('temperature')}</span>
        ${currentText}
        ${apparentTemp}
        ${separator}
        <span>
...
// #####
  ...
  slotValue(slot,value){
    ...
    var daytimeHigh = this.config.entity_daytime_high ? html`<li @click="${() => this.openEntityPopover(this.config.entity_daytime_high)}"><span class="ha-icon"><ha-icon icon="mdi:thermometer"></ha-icon></span>${this.localeText.maxToday} ${Math.round(this._hass.states[this.config.entity_daytime_high].state)}<span> ${this.getUOM('temperature')}</span></li>` : ``;
    ...
    var pop = this.config.entity_pop ? html`<li @click="${() => this.openEntityPopover(this.config.entity_pop)}"><span class="ha-icon"><ha-icon icon="mdi:weather-rainy"></ha-icon></span>${Math.round(this._hass.states[this.config.entity_pop].state)} %${intensity}</li>` : ``;
    var visibility = this.config.entity_visibility ? html`<li @click="${() => this.openEntityPopover(this.config.entity_visibility)}"><span class="ha-icon"><ha-icon icon="mdi:weather-fog"></ha-icon></span>${this.current.visibility}<span class="unit"> ${this.getUOM('length')}</span></li>` : ``;
    var wind = this.config.entity_wind_bearing && this.config.entity_wind_speed ? html`<li @click="${() => this.openEntityPopover(this.config.entity_wind_speed)}"><span class="ha-icon"><ha-icon icon="mdi:weather-windy"></ha-icon></span>${this.current.beaufort}${this.current.windBearing} ${this.current.windSpeed}<span class="unit"> ${this.getUOM('length')}/h</span></li>` : ``;
    var humidity = this.config.entity_humidity ? html`<li @click="${() => this.openEntityPopover(this.config.entity_humidity)}"><span class="ha-icon"><ha-icon icon="mdi:water-percent"></ha-icon></span>${this.current.humidity}<span class="unit"> %</span></li>` : ``;
    var pressure = this.config.entity_pressure ? html`<li @click="${() => this.openEntityPopover(this.config.entity_pressure)}"><span class="ha-icon"><ha-icon icon="mdi:gauge"></ha-icon></span>${this.current.pressure}<span class="unit"> ${this.getUOM('air_pressure')}</span></li>` : ``;
...
get sunSet() {
    ...
    if (this._hass.states[this.config.entity_sun].state == "above_horizon" ) {
      ...
      return {
      'next': html`<li @click="${() => this.openEntityPopover(this.config.entity_sun)}"><span class="ha-icon"><ha-icon icon="mdi:weather-sunset-down"></ha-icon></span>${nextSunSet}</li>`,
      'following': html`<li @click="${() => this.openEntityPopover(this.config.entity_sun)}"><span class="ha-icon"><ha-icon icon="mdi:weather-sunset-up"></ha-icon></span>${nextSunRise}</li>`,
      };
    } else {
      ...
      return {
        'next': html`<li @click="${() => this.openEntityPopover(this.config.entity_sun)}"><span class="ha-icon"><ha-icon icon="mdi:weather-sunset-up"></ha-icon></span>${nextSunRise}</li>`,
        'following': html`<li @click="${() => this.openEntityPopover(this.config.entity_sun)}"><span class="ha-icon"><ha-icon icon="mdi:weather-sunset-down"></ha-icon></span>${nextSunSet}</li>`,
      };
    }
}
