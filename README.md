...
### [Battery State Card / Entity Row](https://github.com/maxwroc/battery-state-card) [v3.0.1]
...
### [Card Mod](https://github.com/thomasloven/lovelace-card-mod) [v3.2.4]
...
### [Kiosk Mode](https://github.com/NemesisRE/kiosk-mode) [v4.6.0]
...
### [Mini Media Player](https://github.com/kalkih/mini-media-player) [v1.16.6]
...
### [Sankey Chart Card](https://github.com/MindFreeze/ha-sankey-chart) [v1.19.0]
...
[ha-version-shield]: https://img.shields.io/badge/2023.12.1-555555?style=flat-square&logo=home-assistant
