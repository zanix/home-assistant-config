...
### [Bambu Lab](https://github.com/greghesp/ha-bambulab) [v2.0.36]
...
### [Kia Uvo / Hyundai Bluelink](https://github.com/Hyundai-Kia-Connect/kia_uvo) [v2.29.0]

A Home Assistant HACS integration that supports Kia Connect(Uvo) and Hyundai Bluelink. The integration supports the EU, Canada and the USA.

Authors: [@fuatakgun](https://github.com/fuatakgun).

### [Mail And Packages](https://github.com/moralmunky/Home-Assistant-Mail-And-Packages) [v0.4.1]
...
### [Kiosk Mode](https://github.com/NemesisRE/kiosk-mode) [v6.4.0]
...
### [Material Rounded Theme   Based On Material You By Google On Android](https://github.com/Nerwyn/material-rounded-theme) [v2.1.10]
...
[ha-version-shield]: https://img.shields.io/badge/2024.11.1-555555?style=flat-square&logo=home-assistant
